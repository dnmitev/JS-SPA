...
app.factory('TripsResource', ['$resource', 'authorization', 'baseServiceUrl', function ($resource, authorization, baseServiceUrl) {
    var headers = authorization.getAuthorizationHeader(),
        TripsResource = $resource(baseServiceUrl + '/api/trips/:id', null, {
